...
Buffer2D<Float3> Denoiser_JBF::Filter(const FrameInfo &frameInfo) {
...
void Denoiser_JBF::Init(const FrameInfo &frameInfo, const Buffer2D<Float3> &filteredColor) {
...
void Denoiser_JBF::Maintain(const FrameInfo &frameInfo) { 
    m_preFrameInfo = frameInfo; 
}

Buffer2D<Float3> Denoiser_JBF::ProcessFrame(const FrameInfo &frameInfo) {
